...
//磁盘阵列
 /*   for(var j = 0; j < data.cpzl.length; j++){
        var obj5 = {name:'',obj_id:'',x:0,y:400,symbol:'',status:'',symbolSize: [60,60]};//storage
        ...
        if(obj5.status == 1){
            obj5.symbol = 'image://../images/yunpt_cpzl01.png';
        }
        else if (obj5.status == 0) {
            obj5.symbol = 'image://../images/yunpt_cpzl02.png';
        }
        end_obj5.push(obj5);
    };*/
    //数据库
