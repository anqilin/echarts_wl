...
//磁盘阵列
 /*   for(var j = 0; j < data.cpzl.length; j++){
        var obj5 = {name:'',obj_id:'',x:0,y:600,symbol:'',status:'',symbolSize: [68,34]};//storage
    ...
    for(var j = 0; j < data.outfhq.length; j++){
        var obj6 = {name:'',obj_id:'',x:0,y:700,symbol:'',status:'',symbolSize: [50,50]};//storage
