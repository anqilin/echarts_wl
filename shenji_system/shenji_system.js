...
function analysis(data){    
  ...
  /*  for(var k = 0; k <data.database.length; k++){
    ...
    for(var j = 0; j < data.storage.length; j++){
        var obj2 = {name:'',obj_id:'',x:0,y:100,symbol:'',status:'',symbolSize: [50,50]};//storage
        ...
        if(j==1){
            if(obj2.status == 1){
                obj2.symbol = 'image://../images/image002_1.png';
            }else if(obj2.status == 0){
                obj2.symbol = 'image://../images/image002_2.png';
...
//磁盘阵列
    for(var j = 0; j < data.cpzl.length; j++){
        var obj5 = {name:'',obj_id:'',x:0,y:300,symbol:'',status:'',symbolSize: [60,120]};//storage
    ...
    for(var j = 0; j < data.sujuku.length; j++){
        var obj6 = {name:'',obj_id:'',x:0,y:200,symbol:'',status:'',symbolSize: [50,50]};//storage
