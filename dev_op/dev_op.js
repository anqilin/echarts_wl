...
function analysis(data){    
    ...
    for(var k = 0; k <data.switchs.length; k++){
        var obj3 = {name:'',x:0,y:400,symbol:'',symbolSize: [50,50]};
  ...
  /*  for(var k = 0; k <data.database.length; k++){
    ...
    for(var j = 0; j < data.storage.length; j++){
        var obj2 = {name:'',obj_id:'',x:0,y:200,symbol:'',status:'',symbolSize: [120,40]};//storage
        ...
        if(stl == 1){
            ...
            obj2.x = 1200/(stl+1-3)*(j%8+1)-(60/2);
            if(j>=8){
                obj2.x=1200/(stl+1-3)*(j-3)-(60/2);
            }
        ...
        if(obj2.kind == 1){
            ...
            if(obj2.status == 1){
                obj2.symbol = 'image://../images/zuomian01.png';
            }else if(obj2.status == 0){
                obj2.symbol = 'image://../images/zuomian02.png';
...
//磁盘阵列
    for(var j = 0; j < data.cpzl.length; j++){
        var obj5 = {name:'',obj_id:'',x:0,y:550,symbol:'',status:'',symbolSize: [60,30]};//storage
