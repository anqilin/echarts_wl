...
function analysis(data){    
    ...
    for(var i = 0; i < data.compute.length; i++){
        var obj1 = {name:'',obj_id:'',x:0,y:0,symbol:'',status:'',symbolSize: [80,80]};//compute
...
//磁盘阵列
    for(var j = 0; j < data.cpzl.length; j++){
        var obj5 = {name:'',obj_id:'',x:0,y:380,symbol:'',status:'',symbolSize: [80,80]};//storage
        ...
        if(cpzl_length == 1){
            ...
            obj5.x = 800/(cpzl_length+1)*(j+1)-(60/2);

        }

        obj5.status = data.cpzl[j].status;
        if(obj5.status == 1){
            obj5.symbol = 'image://../images/sccpzl01.png';
        }
        else if (obj5.status == 0) {
            obj5.symbol = 'image://../images/sccpzl02.png';
        }
        if(j==2){
            if(obj5.status == 1){
                obj5.symbol = 'image://../images/qscpzl01.png';
            }
            else if (obj5.status == 0) {
                obj5.symbol = 'image://../images/qscpzl02.png';
            }
        }
        if(j==3){
            obj5.symbolSize=[80,90];
            if(obj5.status == 1){
                obj5.symbol = 'image://../images/cdk01.png';
            }
            else if (obj5.status == 0) {
                obj5.symbol = 'image://../images/cdk02.png';
            }
        }
        end_obj5.push(obj5);
    };
    ...
    for(var j = 0; j < data.sujuku.length; j++){
        var obj6 = {name:'',obj_id:'',x:0,y:300,symbol:'',status:'',symbolSize: [50,50]};//storage
        ...
        if(sujuku_length == 1){
            ...
            obj6.x = 800/(sujuku_length+1)*(j+1)-(60/2);
