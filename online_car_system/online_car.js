...
function analysis(data){    
    ...
    for(var k = 0; k <data.switchs.length; k++){
        var obj3 = {name:'',x:0,y:150,symbol:'',symbolSize: [50,50]};
   ...
   for(var k = 0; k <data.database.length; k++){
        var obj4 = {name:'',x:0,y:450,symbol:'',symbolSize: [100,10]};
...
//磁盘阵列
    for(var j = 0; j < data.cpzl.length; j++){
        var obj5 = {name:'',obj_id:'',x:0,y:750,symbol:'',status:'',symbolSize: [80,80]};//storage
        ...
        if(obj5.status == 1){
            obj5.symbol = 'image://../images/online_car01.png';
        }
        else if (obj5.status == 0) {
            obj5.symbol = 'image://../images/online_car02.png';
        }
        if(j==2){
            if(obj5.status == 1){
    ...
    for(var j = 0; j < data.sujuku.length; j++){
        var obj6 = {name:'',obj_id:'',x:0,y:600,symbol:'',status:'',symbolSize: [50,50]};//storage
