...
function analysis(data){    
    ...
    for(var k = 0; k <data.switchs.length; k++){
        var obj3 = {name:'',x:0,y:240,symbol:'',symbolSize: [50,50]};
        ...
        obj3.status=data.switchs[k].status;
         if(obj3.status==1){
            // obj3.symbol = 'image://../images/1.png';
         }else if (obj3.status==0){
             //obj3.symbol = 'image://../images/2.png';
         }
        end_obj3.push(obj3);
    };
  ...
  /*  for(var k = 0; k <data.database.length; k++){
    ...
    for(var j = 0; j < data.storage.length; j++){
        var obj2 = {name:'',obj_id:'',x:0,y:140,symbol:'',status:'',symbolSize: [50,50]};//storage
...
//磁盘阵列
    for(var j = 0; j < data.cpzl.length; j++){
        var obj5 = {name:'',obj_id:'',x:0,y:650,symbol:'',status:'',symbolSize: [50,50]};//storage
        ...
        if(cpzl_length == 1){
            ...
            if(j==cpzl_length-1){
                obj5.x = 1200/(cpzl_length+1)*(j+1)+30;
            }
        ...
        if(obj5.status == 1){
            obj5.symbol = 'image://../images/key01.png';
        }
        else if (obj5.status == 0) {
            obj5.symbol = 'image://../images/key02.png';
        }
    ...
    for(var j = 0; j < data.sujuku.length; j++){
        var obj6 = {name:'',obj_id:'',x:0,y:440,symbol:'',status:'',symbolSize: [50,50]};//storage
        ...
        if(sujuku_length == 1){
            ...
            obj6.x = 600/(sujuku_length+1)*(j+1)-(60/2);
