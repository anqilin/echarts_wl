...
function analysis(data){    
 ...
 for(var k = 0; k <data.switchs.length; k++){
    ...
    for(var k = 0; k <data.database.length; k++){
        var obj4 = {name:'',x:0,y:1000,symbol:'',symbolSize: [50,50]};
        obj4.name = data.database[k].name;
            ...
            if(data_length == 1){
                ...
                obj4.x = 1400/(data_length+1)*(k+1)-(20/2);
    ...
    for(var j = 0; j < data.storage.length; j++){
        ...
        // obj2.x = 150*(j+1);
        obj2.y=parseInt(j/7)*100+100+200;
        if(stl == 1){
            obj2.x = 1200/2-(113/2);
        }else{
            obj2.x = 1400/(7+1)*(j%7+1)-(60/2);
...
//磁盘阵列
  for(var j = 0; j < data.cpzl.length; j++){
        var obj5 = {name:'',obj_id:'',x:0,y:850,symbol:'',status:'',symbolSize: [100,10]};//storage
        ...
        if(cpzl_length == 1){
            ...
            obj5.x = 1400/(cpzl_length+1)*(j+1)-(60/2);
    ...
    for(var j = 0; j < data.outfhq.length; j++){
        var obj6 = {name:'',obj_id:'',x:0,y:1150,symbol:'',status:'',symbolSize: [50,50]};//storage
        ...
        if(out_fhq == 1){
            ...
            obj6.x = 1400/(out_fhq+1)*(j+1)-(60/2);
